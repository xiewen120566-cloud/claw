...
export default async function LocaleLayout({
  ...
  return (
    <BaseLayout locale={locale}>
      <Script
        async
        src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4082162765175328"
        crossOrigin="anonymous"
        strategy="beforeInteractive"
      />

      {/* Google tag */}
      <Script async src="https://www.googletagmanager.com/gtag/js?id=G-0FKCXR93S2" crossOrigin='anonymous'
        strategy='beforeInteractive' />
